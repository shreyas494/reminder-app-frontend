...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen text-slate-900 dark:text-slate-100">
      <header className="sticky top-0 z-50 h-16 border-b border-indigo-100/70 dark:border-indigo-900/40 bg-white/80 dark:bg-[#0b1120]/70 backdrop-blur-xl">
        <div className="h-full px-4 sm:px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={() => setSidebarOpen((prev) => !prev)}
              className="lg:hidden inline-flex items-center justify-center w-9 h-9 rounded-lg border border-indigo-100 dark:border-indigo-900/40 text-slate-600 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 transition-colors"
            >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              ...
              className={`inline-flex items-center justify-center px-2.5 sm:px-3 h-9 rounded-lg border text-xs sm:text-sm font-medium transition-colors ${
            ...
            <div className="relative">
              <button
                ...
                className="inline-flex items-center gap-2 px-3 h-9 rounded-lg border border-indigo-100 dark:border-indigo-900/40 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 transition-colors"
              >
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 w-64 rounded-xl border border-indigo-100 dark:border-indigo-900/40 bg-white/95 dark:bg-slate-900/95 shadow-xl p-4 backdrop-blur">
      ...
      <div className="flex min-h-[calc(100vh-64px)]">
        <aside className={`fixed lg:static inset-y-16 left-0 z-40 w-72 lg:w-64 border-r border-indigo-100/70 dark:border-indigo-900/40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl transform transition-transform duration-200 ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}>
