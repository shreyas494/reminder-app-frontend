        ...
        <div className="backdrop-blur-xl bg-white/70 dark:bg-[#111827]/60 border border-white/50 dark:border-white/10 shadow-2xl rounded-3xl p-8 transition-all duration-300 hover:shadow-indigo-500/10">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="w-[240px] h-11 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 text-sm font-semibold hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors inline-flex items-center justify-center gap-2"
            >
