...
export default function AdminUsers() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] px-6 py-10 bg-gray-100 dark:bg-[#0b1120] transition-colors">
      {/* HEADER */}
      ...
      {/* TABLE */}
      <div className="max-w-7xl mx-auto bg-white dark:bg-[#111827] border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl overflow-hidden">
        <table className="w-full border-collapse">
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan="6" className="text-center py-16 text-gray-600 dark:text-gray-400">
                  Loading users…
                </td>
              </tr>
            ) : users.length === 0 ? (
...
function Td({ children }) {
  return <td className="p-4 text-gray-700 dark:text-gray-300">{children}</td>;
}
